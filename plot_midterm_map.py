...
def plot_side_by_side_map():
    ...
    df = pd.read_csv("midterm_prototype_dataset.csv")
    ...
    map_data.plot(
        ...
        edgecolor='0.5', 
        legend=True,
        legend_kwds={'label': "Total Crimes", 'orientation': "horizontal"}
    )
    ax2.set_title('Total Crime Volume', fontsize=15)
    ax2.axis('off')
    
    plt.tight_layout()
    output_img = f"midterm_map_{target_month}.png"
